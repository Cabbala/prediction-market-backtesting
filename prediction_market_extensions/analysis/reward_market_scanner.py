    ...
    def build_manifest(self, scan_payload: dict[str, Any], *, source_path: str, limit: int = 25) -> dict[str, Any]:
        ...
        return {
            ...
            "eligibility_rules": [
                ...
                "unexpired_market",
                "complete_two_sided_books_for_both_tokens",
                "explicit_reward_evidence_preferred_but_not_required_for_proxy_rows",
            ],
            "scoring_notes": [
                "reward evidence, liquidity, 24h volume, and two-sided 5c depth increase score",
                "wide spread, thin depth, near expiry, tail price, and missing reward evidence add risk flags and reduce score",
